    ...
    return (
        <nav className='fixed top-0 left-0 right-0 z-20 bg-[#181818] bg-opacity-90'>
            <div className='flex flex-wrap items-center justify-between mx-auto py-3'>
                ...
                <div className='flex'>
                    <Connectlink href={'https://www.linkedin.com/in/arpit-joshi-5779ab284/'} path='/images/linkedin.png'/>
                    <Connectlink href={'https://github.com/ohhpeejoshi'} path= '/images/github.png'/>
                    <Connectlink href={'https://drive.google.com/file/d/1oPWjFomBejv406Q7WIEeYFtmQ1IcBXhq/view?usp=sharing'} path='/images/resume.png'/>
                </div>
            </div>
