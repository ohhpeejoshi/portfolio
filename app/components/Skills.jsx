  ...
  return (
    <section className='mt-[160px] bg-[#313131] rounded-xl md:py-10 py-7 md:w-3/4 w-full mx-auto' id="skills">
      <div className='text-center'>
        ...
        <p className='text-[#ADB7BE] text-md mt-5 mx-10 mb-7'>&quot;My expertise in modern technologies and programming languages provides a toolkit to develop creative solutions, enabling success in dynamic and evolving project environments.&quot;</p>
